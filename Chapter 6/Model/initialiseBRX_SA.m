...
%extPFC = 1.00; %down this and up PRSRE
extNoise = 0.01; % controls external (uniform noise), to PFC and to SMA
...
pfc.pfcNoise = 0.01*randn(1,num_trials);
sma.smaNoise = 0.01*randn(num_trials,timeSteps);
...
%weights.w_RULE_PRES = 0.99;  % this parameter is essential
