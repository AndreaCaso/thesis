for ss = 1:num_circles
    ...
    sma.o_ST1_SMA(ss,tt) = sigmf(sma.a_ST1_SMA(ss,tt), [satfnc.alpha_str_sma(ss) satfnc.beta_str_sma(ss)]);
...
for ss = 1:num_circles
    ...
    sma.o_ST2_SMA(ss,tt) = sigmf(sma.a_ST2_SMA(ss,tt), [satfnc.alpha_str_sma(ss) satfnc.beta_str_sma(ss)]);
