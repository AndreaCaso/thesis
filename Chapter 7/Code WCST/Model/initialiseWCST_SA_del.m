...
%extPFC = []; %controls the external to the cog schema: Last 0.8
extNoise = 0.05; % controls external (uniform noise), to PFC and to SMA
...
pfc.pfcNoise = 0.05*unifrnd(-1,1,1,lstim+1);
sma.smaNoise = 0.05*unifrnd(-1,1,4,timeSteps);
...
%reward.discount_TDV = []; %gamma value in temporal difference learning
