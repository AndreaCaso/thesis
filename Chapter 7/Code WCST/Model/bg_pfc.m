for ss = [1 2 3]
    ...
    pfc.o_ST1_PFC(ss,tt) = sigmf(pfc.a_ST1_PFC(ss,tt), [satfnc.alpha_str_pfc(ss) satfnc.beta_str_pfc(ss)]);
...
for ss = [1 2 3]
    ...
    pfc.o_ST2_PFC(ss,tt) = sigmf(pfc.a_ST2_PFC(ss,tt), [satfnc.alpha_str_pfc(ss) satfnc.beta_str_pfc(ss)]);
